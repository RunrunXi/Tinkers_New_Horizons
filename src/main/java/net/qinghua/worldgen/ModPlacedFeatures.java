...
public class ModPlacedFeatures {
    // 矿石key
    public static final ResourceKey<PlacedFeature> UELIBLOOM_ORE_PLACED_KEY = registerKey("uelibloom_ore_placed");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(TinkersNH.MOD_ID, name));
    }
